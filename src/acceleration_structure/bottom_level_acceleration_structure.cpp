...
namespace nugiEngine {
	EngineBottomLevelAccelerationStructure::EngineBottomLevelAccelerationStructure(EngineDevice& appDevice, std::shared_ptr<EngineModel> model) : appDevice{appDevice} {
